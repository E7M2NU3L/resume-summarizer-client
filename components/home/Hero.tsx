    ...
    <div className='relative text-admin-1 font-semibold'>
        ...
        >
          <main className='max-w-[40vh] sm:max-w-[60vh]'>
            ...
            <Button className='bg-gradient-to-tr from-admin-2 via-admin-3 to-admin-1 mt-[0.8rem] hover:bg-gradient-to-tr hover:from-admin-4 hover:via-admin-2 hover:to-admin-3 text-fg-2 font-semibold hover:font-bold hover:scale-110 hover:translate-x-2 hover:translate-y-2 transition-all duration-200 ease-in-out'>
