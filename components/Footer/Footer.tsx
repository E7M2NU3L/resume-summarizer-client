...
const Footer = () => {
  ...
  const linkArray = [
    { id: 1, link: '/planning', text: 'Planning', desc: 'for human resource planning and staffing tools' },
    { id: 2, link: '/resume-sum', text: 'Resume Summarize', desc: 'summarize resume and visualize results to select the right persons' },
    { id: 3, link: '/cv-sum', text: 'Cv Summarize', desc: 'summarize Cv to Choose the right Professional' },
  ];

  const ProdServs = [
    { id: 4, text: 'Resume Builder', link: '/resume-builder-app', desc: 'interview and job seekers' },
    { id: 5, text: 'roamap Publishing App', link: '/roadmap-publisher', desc: 'presentations' },
    { id: 6, text: 'work-pro', link: '/workplace-productivity', desc: 'collaborated workplace' },
    { id: 7, text: 'See-more', link: '/jehr-solutions', desc: 'Visit Website' },
  ];
  ...
  return (
    <div className='min-h-[40vh] flex flex-col justify-center items-center sm:flex-col bg-admin-4 text-fg-1'>
      <section className='flex flex-col sm:flex-row gap-y-[1rem] px-[2rem] py-[1rem] items-start justify-between w-full'>
        <header>
          <Typography variant='h5' component='div' className='text-fg-1' sx={{ fontFamily: "Oswald, sans-serif", fontWeight: 700 }}>
            Jehr-autoHR
          </Typography>
          <Typography variant='h6' component="div" className='text-fg-1' sx={{ fontFamily: "Oswald, sans-serif", fontWeight: 700, fontSize: 12 }}>
            Developed by <span className='text-fg-2'>JEHR-SOLUTIONS</span>
          </Typography>
        </header>
        <section className='flex justify-center items-center flex-col'>
          <Typography component="div" variant='h6' sx={{ fontFamily: "Anton, sans-serif", fontWeight: 700, fontSize: 18 }}>
            Quick Links
          </Typography>
          <ul className='pt-[1.3rem]'>
            {linkArray.map((context) => (
              <React.Fragment key={context.id}>
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger className='flex flex-col justify-center items-center pb-[0.8rem]'>
                    ...
                    <TooltipContent className='bg-admin-4'>
                      <Typography component="div" variant='h5' sx={{ fontFamily: "Oswald, sans-serif", fontWeight: 700, fontSize: 12 }} className='text-fg-1'>
                        Tip:
                      </Typography>
        ...
        <section>
          <Typography variant='h6' component="div" className='text-fg-2' sx={{ fontFamily: "Anton, sans-serif", fontSize: 16, fontWeight: 700 }}>
