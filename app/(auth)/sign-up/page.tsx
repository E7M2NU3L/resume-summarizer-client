...
const SignUp = () => {
  ...
  return (
    <div className='flex justify-center items-center min-h-[90vh]'>
      ...
      <section className='relative min-h-[75vh] w-[300px] sm:w-[400px] bg-admin-2 sm:flex justify-center items-center flex-col px-[1rem] hidden '>
        <main className='flex flex-col justify-center text-center'>
          <Typography variant='h5' component="div" className='text-fg-2 mb-[1rem]' sx={{
            fontFamily: "Oswald, sans-serif",
            fontWeight: 700,
          }}>
            Hello <span className='text-purple-200'>HR</span>
          </Typography>
          ...
          <h6 className='text-md text-fg-2' style={{
            ...
            <span className='ps-3'></span>to keep Connected with jehr-autoHR, please Provide Login with Your Credentials
          </h6>
        </main>
        ...
        <Link href="/sign-in" className='flex w-full px-[2rem] items-start'>
      ...
      <section className='min-h-[75vh] w-auto sm:w-[600px] bg-fg-2 flex flex-col justify-start items-center'>
        ...
        <section className='flex justify-center items-center space-x-8 mt-[1.8rem]'>
          ...
          <div className='rounded-full bg-gray-300 h-[2.4rem] cursor-pointer w-[2.4rem] hover:translate-x-1 hover:scale-110 hover:shadow-md hover:shadow-admin-2 transition-all duration-300 ease-in-out'>
        ...
        <form onSubmit={handleSubmit} className='w-full flex flex-col justify-center items-center pt-[1.6rem]'>
          ...
          <div>
            ...
            <input value={userName} placeholder='' name='userName' className='rounded-md outline-none shadow-md shadow-gray-300 bg-gray-300 w-[300px] px-[0.8rem] py-[8px] mt-[3px] mb-[9px] text-gray-800' onChange={handleUserName} />
          </div>
        ...
        <Link href="/sign-in" className='flex sm:hidden pt-[12px]'>
          <h5 className='text-gray-800 text-[12px] font-light'>
            Already, have an Account? <span className='hover:text-green-200 hover:translate-x-1 transition-all duration-300 ease-in-out'>Sign-in</span> 
          </h5>
        </Link>
      </section>
      </main>
